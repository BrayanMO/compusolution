<header class="bg-blueGray-700 sticky top-0" style="z-index: 900" x-data="dropdown">
    <div class="container flex items-center h-16 justify-between md:justify-start">
        ...
        <a href="/" class="mx-6">
            ...
            <span class="text-lg  h-7 w-aut text-white cursor-pointer font-semibold ">Compu</span>
            <span class="text-lg font-bold h-7 w-aut text-orange-400 cursor-pointer">Solution</span>
        </a>
        ...
        <div class="bg-white h-full overflow-y-auto">
            ...
            @auth
                ...
                <a href=""
                    ...
                    class=" py-2 px-4 text-sm flex items-center text-gray-600 hover:bg-orange-500 hover:text-white">
            ...
            @else
                <a href="{{ route('login') }}" class=" py-2 px-4 text-sm flex items-center text-gray-600 hover:bg-orange-500 hover:text-white">
                ...
                <a href="{{ route('register') }}" class=" py-2 px-4 text-sm flex items-center text-gray-600 hover:bg-orange-500 hover:text-white">
